...
bool AuthProvider::authenticate(const QString &username, const QString &password)
{
...
void AuthProvider::initialize(const QLatin1String &_authTableName,
                              const QLatin1String &_authIDFiled,
                              const QLatin1String &_authPassField,
